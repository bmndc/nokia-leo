...
public:
  ...
  static void NotifyProgress(Decoder* aDecoder);
...
public:
  ...
  explicit DecodingTask(Decoder* aDecoder);
...
public:
  ...
  explicit MetadataDecodingTask(Decoder* aDecoder);
...
public:
  ...
  explicit AnonymousDecodingTask(Decoder* aDecoder);
