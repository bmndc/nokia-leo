...
public:
  ...
  virtual void InitTouchLocation() override;
...
private:
   ...
   *
   * If conditions below are all false then this key event will be relayed to
   * Keyboard App by KeyboardAppProxy in the chrome process.
   *   1. Event is generated by IME / Keyboard App.
   *   2. This function is invoked in content process.
   *
   * aEvent - This is a event candidate we might relay to IME / Keyboard App
   * aStatus - If event is relayed to Keyboard App then status will be set as
