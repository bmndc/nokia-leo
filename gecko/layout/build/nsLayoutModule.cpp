...
#include "mozilla/dom/network/TrafficStats.h"
...
#ifdef ENABLE_OMADM_REDBEND
#include "nsOmadmAgent.h"
#endif
...
#include "mozilla/dom/TEEService.h"
#endif
...
#ifdef KAI_GEOLOC
NS_GENERIC_FACTORY_SINGLETON_CONSTRUCTOR(nsIGeolocationNetworkProvider,
...
#ifdef ENABLE_OMADM_REDBEND
NS_GENERIC_FACTORY_CONSTRUCTOR(OmadmAgent)
#endif
...
#ifdef ENABLE_TEE_SUI
NS_GENERIC_FACTORY_SINGLETON_CONSTRUCTOR(nsITEEService,
                                         TEEService::GetSingleton)
#endif
...
NS_GENERIC_FACTORY_CONSTRUCTOR(TrafficStats)
...
NS_DEFINE_NAMED_CID(TRAFFIC_STATS_CID);
...
#ifdef ENABLE_OMADM_REDBEND
NS_DEFINE_NAMED_CID(NS_OMADMAGENT_CID);
#endif
...
#ifdef ENABLE_TEE_SUI
NS_DEFINE_NAMED_CID(TEE_SERVICE_CID);
#endif
...
static const mozilla::Module::CIDEntry kLayoutCIDs[] = {
  ...
  { &kTRAFFIC_STATS_CID, false, nullptr, TrafficStatsConstructor },
...
#endif
#ifdef KAI_GEOLOC
  { &kKAI_GEOLOCATION_PROVIDER_CID, false, nullptr, nsIGeolocationNetworkProviderConstructor },
#endif
...
#endif
#ifdef ENABLE_OMADM_REDBEND
  { &kNS_OMADMAGENT_CID, false, nullptr, OmadmAgentConstructor },
#endif
#ifdef MOZ_PRESENTATION
...
#endif
#ifdef ENABLE_TEE_SUI
  { &kTEE_SERVICE_CID, false, nullptr, nsITEEServiceConstructor },
#endif
  { nullptr }
};
...
static const mozilla::Module::ContractIDEntry kLayoutContracts[] = {
  ...
  { TRAFFIC_STATS_CONTRACTID, &kTRAFFIC_STATS_CID },
...
#endif
#ifdef ENABLE_OMADM_REDBEND
  { OMADMAGENT_CONTRACTID, &kNS_OMADMAGENT_CID },
#endif
...
#endif
#ifdef ENABLE_TEE_SUI
  { TEE_SERVICE_CONTRACTID, &kTEE_SERVICE_CID },
#endif
  { nullptr }
};
...
#endif
#if defined(MOZ_WIDGET_GONK) && defined(ENABLE_TV)
