...
RuntimeList.prototype = {
  ...
  update: function() {
    ...
    // Todo: It will be confirmed whether using addon to communicate with pc in the future. If not, it will be removed.
    ...
    dumpn("Current usbRuntime.length is " + runtimeList.usb.length);

    if (runtimeList.usb.length === 0) {
