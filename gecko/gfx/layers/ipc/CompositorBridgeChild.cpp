...
#ifdef CBC_DEBUG
namespace PCB = PCompositorBridge;
static struct IpcRecentHistory::IpcCommand gCommandLut[] {
  PCB::Msg_ClearCachedResources__ID,                "ClearCachedResources",
  PCB::Msg_DidComposite__ID,                        "DidComposite",
  PCB::Msg_InvalidateLayers__ID,                    "InvalidateLayers",
  PCB::Msg_CompositorUpdated__ID,                   "CompositorUpdated",
  PCB::Msg_Overfill__ID,                            "Overfill",
  PCB::Msg_UpdatePluginConfigurations__ID,          "UpdatePluginConfigurations",
  PCB::Msg_HideAllPlugins__ID,                      "HideAllPlugins",
  PCB::Msg_SharedCompositorFrameMetrics__ID,        "SharedCompositorFrameMetrics",
  PCB::Msg_ReleaseSharedCompositorFrameMetrics__ID, "ReleaseSharedCompositorFrameMetrics",
  PCB::Msg_RemotePaintIsReady__ID,                  "RemotePaintIsReady",
  0,                                                nullptr,
};
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory = new IpcRecentHistory(16, gCommandLut);
#endif
}
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->dump();
  delete mIpcRecentHistory;
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_InvalidateLayers__ID);
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_CompositorUpdated__ID);
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_UpdatePluginConfigurations__ID);
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_HideAllPlugins__ID);
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_DidComposite__ID);
#endif
  if (mLayerManager) {
    MOZ_ASSERT(aId == 0);
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_Overfill__ID);
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_ClearCachedResources__ID);
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_SharedCompositorFrameMetrics__ID);
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_ReleaseSharedCompositorFrameMetrics__ID);
  //mIpcRecentHistory->dump();
#endif
...
{
#ifdef CBC_DEBUG
  mIpcRecentHistory->push(PCompositorBridge::Msg_RemotePaintIsReady__ID);
#endif
