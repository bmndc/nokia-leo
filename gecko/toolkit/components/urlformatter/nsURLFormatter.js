...
nsURLFormatterService.prototype = {
  ...
  _defaults: {
    ...
    KAIOS_GEO_E911_API_KEY:  () =>  "@KAI_KAIOS_GEO_E911_API_KEY@",
    KAIOS_GEO_SUBMIT_API_KEY:  () => "@KAI_KAIOS_GEO_SUBMIT_API_KEY@",
    ...
    KAIOS_CUSTOMIZATION_API_KEY:  () => "@KAI_KAIOS_CUSTOMIZATION_API_KEY@",
    KAIOS_LOG_SERVICE_KEY:  () => "@KAI_KAIOS_LOG_SERVICE_KEY@",
  ...
  formatURL: function uf_formatURL(aFormat) {
    ...
    return aFormat.replace(/%([A-Z_0-9]+)%/g, replacementCallback);
  },
