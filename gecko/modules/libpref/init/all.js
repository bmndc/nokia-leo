...
pref("devtools.apps.forbidden-permissions", "embed-apps,engmode-extension,embed-widgets");
...
pref("security.apps.privileged.CSP.default", "default-src * data: blob:; script-src 'self' http://127.0.0.1 http://127.0.0.1:8081 http://local-device.kaiostech.com:8081; object-src 'none'; style-src 'self' 'unsafe-inline'");
...
pref("layout.accessiblecaret.timeout_ms", 6000);
...
// the page.
// Bug 79194 - Hide carets and text selection dialog during scrolling.
...
pref("identity.kaiaccounts.auth.uri", "https://auth.kaiostech.com");
pref("identity.kaiaccounts.api.uri", "https://api.kaiostech.com");
pref("identity.kaiaccounts.auth.resources.oauth2", "/oauth2/v1.0");
pref("identity.kaiaccounts.api.resources.core", "/core/v2.0");
...
pref("dom.secureelement.transmit.mgt_cmd", false);
#endif
