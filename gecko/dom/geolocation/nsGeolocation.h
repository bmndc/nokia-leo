...
public:
  ...
  // Update the accuracy/e911 and notify the provider if changed
  void     UpdateOptions(bool aForceHigh = false, bool aForceE911 = false);
...
private:
  ...
  // Current state of requests for E911 network positioning
  bool mE911;
...
public:
  ...
  // Check to see if any active request requires E911 network positioning
  bool E911Requested();
