...
NotificationStorage.prototype = {
  ...
  put: function(origin, id, title, dir, lang, body, tag, icon, image,
                alertName, data, behavior, requireInteraction, actions,
  ...
  getByID: function(origin, id, callback) {
    ...
    var GetByIDProxyCallback = function(id, originalCallback) {
      ...
      this.handle = function(id, title, dir, lang, body,
                             tag, icon, image, data, behavior,
                             requireInteraction, actions, silent,
