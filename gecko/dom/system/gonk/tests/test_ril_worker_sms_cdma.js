 ...
 *        See PDU_CDMA_MSG_TELESERVICE_ID_XXX in ril_const.js.
 * @param address
...
add_test(function test_processCdmaSmsWapPush() {
  ...
  function test_CdmaSmsWapPdu(wdpData, reversed) {
    ...
    for (let i = 0; i < wdpData.length; i++) {
      ...
      let pdu = {
        teleservice: PDU_CDMA_MSG_TELESERVICE_ID_WAP,
    ...
    equal("sms-received", postedMessage.rilMessageType);
    equal(PDU_CDMA_MSG_TELESERVICE_ID_WAP, postedMessage.teleservice);
