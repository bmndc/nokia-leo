...
// RTT feature
this.REQUEST_SEND_RTT_MODIFY = 140;
this.REQUEST_SEND_RTT_MODIFY_RESPONSE = 141;
this.REQUEST_SEND_RTT_MESSAGE = 142;
...
this.UNSOLICITED_RADIO_CAPABILITY = 1042;
this.UNSOLICITED_ON_SS = 1043;
this.UNSOLICITED_STK_CC_ALPHA_NOTIFY = 1044;
this.UNSOLICITED_LCEDATA_RECV = 1045;
this.UNSOLICITED_PCO_DATA = 1046;
this.UNSOLICITED_MODEM_RESTART = 1047;

//RTT feature
this.UNSOLICITED_RTT_MODIFY = 1050;
this.UNSOLICITED_RTT_MODIFY_RESPONSE = 1051;
this.UNSOLICITED_RTT_MESSAGE = 1052;
...
this.KAIOS_ERROR_BASE = 3100;
this.ERROR_NOT_ALLOWED_WHEN_NCK = this.KAIOS_ERROR_BASE + 1;
...
this.GECKO_ERROR_NOT_ALLOWED_WHEN_NCK = "NotAllowedWhenNCK";
...
RIL_ERROR_TO_GECKO_ERROR[ERROR_NOT_ALLOWED_WHEN_NCK] = GECKO_ERROR_NOT_ALLOWED_WHEN_NCK;
...
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_ONLY = "tdscdma";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_WCDMA = "tdscdma/wcdma";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_LTE = "tdscdma/lte";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM = "tdscdma/gsm";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM_LTE = "tdscdma/gsm/lte";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM_WCDMA = "tdscdma/wcdma/gsm";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_WCDMA_LTE = "tdscdma/wcdma/lte";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM_WCDMA_LTE = "tdscdma/gsm/wcdma/lte";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM_WCDMA_CDMA_EVDO_AUTO = "tdscdma/gsm/wcdma/cdma/ecdo";
this.GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_LTE_CDMA_EVDO_GSM_WCDMA = "tdscdma/cdma/evdo/gsm/wcdma";
this.GECKO_PREFERRED_NETWORK_TYPE_LTE_GSM = "lte/gsm";

this.RIL_PREFERRED_NETWORK_TYPE_TO_GECKO = [
  GECKO_PREFERRED_NETWORK_TYPE_WCDMA_GSM,                                  //  0
  GECKO_PREFERRED_NETWORK_TYPE_GSM_ONLY,                                   //  1
  GECKO_PREFERRED_NETWORK_TYPE_WCDMA_ONLY,                                 //  2
  GECKO_PREFERRED_NETWORK_TYPE_WCDMA_GSM_AUTO,                             //  3
  GECKO_PREFERRED_NETWORK_TYPE_CDMA_EVDO,                                  //  4
  GECKO_PREFERRED_NETWORK_TYPE_CDMA_ONLY,                                  //  5
  GECKO_PREFERRED_NETWORK_TYPE_EVDO_ONLY,                                  //  6
  GECKO_PREFERRED_NETWORK_TYPE_WCDMA_GSM_CDMA_EVDO,                        //  7
  GECKO_PREFERRED_NETWORK_TYPE_LTE_CDMA_EVDO,                              //  8
  GECKO_PREFERRED_NETWORK_TYPE_LTE_WCDMA_GSM,                              //  9
  GECKO_PREFERRED_NETWORK_TYPE_LTE_WCDMA_GSM_CDMA_EVDO,                    // 10
  GECKO_PREFERRED_NETWORK_TYPE_LTE_ONLY,                                   // 11
  GECKO_PREFERRED_NETWORK_TYPE_LTE_WCDMA,                                  // 12
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_ONLY,                              // 13
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_WCDMA,                             // 14
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_LTE,                               // 15
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM,                               // 16
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM_LTE,                           // 17
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM_WCDMA,                         // 18
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_WCDMA_LTE,                         // 19
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM_WCDMA_LTE,                     // 20
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_GSM_WCDMA_CDMA_EVDO_AUTO,          // 21
  GECKO_PREFERRED_NETWORK_TYPE_TD_SCDMA_LTE_CDMA_EVDO_GSM_WCDMA,           // 22
  GECKO_PREFERRED_NETWORK_TYPE_LTE_GSM
];

this.GECKO_SUPPORTED_NETWORK_TYPES_DEFAULT = "gsm,wcdma,lte";
...
this.NETWORK_CREG_TECH_TD_SCDMA = 17;
this.NETWORK_CREG_TECH_IWLAN = 18;
this.NETWORK_CREG_TECH_LTE_CA = 19;
...
this.ICC_EF_CPHS_CFF = 0x6f13; // CallForward flags
...
// TS 131.102 4.2.64 EF_CFIS, size is 16 bytes
this.CFIS_RECORD_SIZE_BYTES = 16;
...
//Subsidy Lock Type facility. 3GPP TS 22.022
//SUBSIDY_LOCK_SIM_NETWORK NCK
this.SUBSIDY_LOCK_FACILITY_NCK = 'PN';
//SUBSIDY_LOCK_NETWORK_SUBSET NSCK
this.SUBSIDY_LOCK_FACILITY_NSCK = 'PU';
//SUBSIDY_LOCK_SIM_CORPORATE CCK
this.SUBSIDY_LOCK_FACILITY_CCK = 'PC';
//SUBSIDY_LOCK_SIM_SERVICE_PROVIDER  SPCK
this.SUBSIDY_LOCK_FACILITY_SPCK = 'PP';
//SUBSIDY_LOCK_SIM_SIM PCK
this.SUBSIDY_LOCK_FACILITY_PCK = 'PS';
//SUBSIDY_LOCK_SIM_NETWORK_PUK PUK for NCK
this.SUBSIDY_LOCK_FACILITY_NCK_PUK = 'PNP';
//SUBSIDY_LOCK_NETWORK_SUBSET_PUK   PUK for NSCK 
this.SUBSIDY_LOCK_FACILITY_NSCK_PUK = 'PUP';
//SUBSIDY_LOCK_SIM_CORPORATE_PUK  PUK for CCK
this.SUBSIDY_LOCK_FACILITY_CCK_PUK = 'PCP';
//SUBSIDY_LOCK_SIM_SERVICE_PROVIDER_PUK PUK for SPCK
this.SUBSIDY_LOCK_FACILITY_SPCK_PUK = 'PPP';
//SUBSIDY_LOCK_SIM_SIM_PUK PUK for PCK
this.SUBSIDY_LOCK_FACILITY_PCK_PUK = 'PSP';

this.SUBSIDY_LOCK_FACLITYS = [
  SUBSIDY_LOCK_FACILITY_NCK,
  SUBSIDY_LOCK_FACILITY_NSCK,
  SUBSIDY_LOCK_FACILITY_CCK,
  SUBSIDY_LOCK_FACILITY_SPCK,
  SUBSIDY_LOCK_FACILITY_PCK,
  SUBSIDY_LOCK_FACILITY_NCK_PUK,
  SUBSIDY_LOCK_FACILITY_NSCK_PUK,
  SUBSIDY_LOCK_FACILITY_CCK_PUK,
  SUBSIDY_LOCK_FACILITY_SPCK_PUK,
  SUBSIDY_LOCK_FACILITY_PCK_PUK
];

this.SUBSIDY_LOCK_STATUS_NOT_SUPPORTE_QUERY = 255;
...
// Current supported fields:USIM_PBR_EMAIL,USIM_PBR_ANR0
//Adding more fields to read will increasing I/O
// time dramatically, do check the performance is acceptable when you add
// more fields.
//Disable USIM_PBR_EMAIL,USIM_PBR_ANR0 fields as
// 1 no one using it and 2 it need some error handling.
this.USIM_PBR_FIELDS = [];
...
this.GECKO_DATACALL_AUTH_DEFAULT = GECKO_DATACALL_AUTH_NONE;
...
this.GECKO_CARDLOCK_TO_FACILITY_CODE = {};
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_NCK] = SUBSIDY_LOCK_FACILITY_NCK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_NSCK] = SUBSIDY_LOCK_FACILITY_NSCK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_CCK] = SUBSIDY_LOCK_FACILITY_CCK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_SPCK] = SUBSIDY_LOCK_FACILITY_SPCK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_PCK] = SUBSIDY_LOCK_FACILITY_PCK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_NCK_PUK] = SUBSIDY_LOCK_FACILITY_NCK_PUK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_NSCK_PUK] = SUBSIDY_LOCK_FACILITY_NSCK_PUK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_CCK_PUK] = SUBSIDY_LOCK_FACILITY_CCK_PUK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_SPCK_PUK] = SUBSIDY_LOCK_FACILITY_SPCK_PUK;
GECKO_CARDLOCK_TO_FACILITY_CODE[GECKO_CARDLOCK_PCK_PUK] = SUBSIDY_LOCK_FACILITY_PCK_PUK;
...
this.PDU_CDMA_MSG_TELESERVICE_ID_SMS  = 0x1002;   // SMS
this.PDU_CDMA_MSG_TELESERVICE_ID_WAP  = 0x1004;   // WAP
this.PDU_CDMA_MSG_TELESERVICE_ID_WEMT = 0x1005;   // Wireless Enhanced Messaging Teleservice
                                                  // required for fragmented SMS
this.PDU_CDMA_MSG_TELESERVICE_ID_SUPL = 0x1013;   // SUPL INIT message (OMA-TS-ULP)
