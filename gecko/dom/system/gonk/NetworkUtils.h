...
#define COPY_FIELD(prop) prop = aOther.prop;
    ...
    COPY_OPT_STRING_FIELD(mHiddenType, EmptyString())
...
#ifdef DONGLE
  CommandResult setUSBLocalTethering(NetworkParams& aOptions);
  CommandResult setUSBNatTethering(NetworkParams& aOptions);
#endif
...
#ifdef DONGLE
  static const CommandFunc sEnableUsbLocalTetherChain[];
  static const CommandFunc sEnableUsbNatTetherChain[];
  static const CommandFunc sDisableUsbLocalTetherChain[];
  static const CommandFunc sDisableUsbNatTetherChain[];
#endif
...
#ifdef DONGLE
  static void dongleTetheringSuccess(PARAMS);
#endif
