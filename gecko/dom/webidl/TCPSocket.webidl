...
interface LegacyMozTCPSocket {
  /**
   * Legacy constructor for TCPSocket API compatibility.
   */
  [Throws]
  TCPSocket open(DOMString host, unsigned short port, optional SocketOptions options);

  /**
   * Legacy constructor for TCPServerSocket API compatibility.
   *
   ...
   */
  [Throws]
  TCPServerSocket listen(unsigned short port, optional ServerSocketOptions options,
