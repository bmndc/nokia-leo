 ...
 * Enum IccAppType
 */
#define ASSERT_ICC_APP_TYPE_EQUALITY(webidlState, xpidlState) \
  ASSERT_EQUALITY(IccAppType, webidlState, xpidlState)

ASSERT_ICC_APP_TYPE_EQUALITY(Unknown, APPTYPE_UNKNOWN);
ASSERT_ICC_APP_TYPE_EQUALITY(Sim, APPTYPE_SIM);
ASSERT_ICC_APP_TYPE_EQUALITY(Usim, APPTYPE_USIM);
ASSERT_ICC_APP_TYPE_EQUALITY(Ruim, APPTYPE_RUIM);
ASSERT_ICC_APP_TYPE_EQUALITY(Csim, APPTYPE_CSIM);
ASSERT_ICC_APP_TYPE_EQUALITY(Isim, APPTYPE_ISIM);

#undef ASSERT_ICC_APP_TYPE_EQUALITY
