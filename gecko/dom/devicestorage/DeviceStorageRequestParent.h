...
private:
  ...
  class TotalSpaceFileEvent : public CancelableFileEvent
  {
    public:
      TotalSpaceFileEvent(DeviceStorageRequestParent* aParent,
                         already_AddRefed<DeviceStorageFile>&& aFile)
        : CancelableFileEvent(aParent, Move(aFile)) {}
      virtual ~TotalSpaceFileEvent() {}
      virtual nsresult CancelableRun();
  };
 ...
 class PostTotalSpaceResultEvent : public CancelableRunnable
 {
    public:
      PostTotalSpaceResultEvent(DeviceStorageRequestParent* aParent,
                               uint64_t aTotalSpace);
      virtual ~PostTotalSpaceResultEvent();
      virtual nsresult CancelableRun();
    private:
