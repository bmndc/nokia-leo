...
NS_INTERFACE_MAP_BEGIN_CYCLE_COLLECTION_INHERITED(Kaipay)
NS_INTERFACE_MAP_END_INHERITING(DOMRequest)

NS_IMPL_ADDREF_INHERITED(Kaipay, DOMRequest)
NS_IMPL_RELEASE_INHERITED(Kaipay, DOMRequest)

NS_IMPL_CYCLE_COLLECTION_INHERITED(Kaipay, DOMRequest,
                                   mProxy)

NS_IMPL_CYCLE_COLLECTION_TRACE_BEGIN_INHERITED(Kaipay, DOMRequest)
NS_IMPL_CYCLE_COLLECTION_TRACE_END

/* virtual */ JSObject*
Kaipay::WrapObject(JSContext* aCx, JS::Handle<JSObject*> aGivenProto)
{
  return KaipayBinding::Wrap(aCx, this, aGivenProto);
}

nsresult
Kaipay::Initialize(nsPIDOMWindowInner* aWindow,
                     JSContext* aCx,
...
Kaipay::Kaipay(nsPIDOMWindowInner* aWindow)
  : DOMRequest(aWindow)
{
}
