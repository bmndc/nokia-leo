                                    ...
                                    nsIMobileMessageThread** aThread)
{
  *aThread = nullptr;
  ...
  data.lastAttachmentStatus() = aLastAttachmentStatus;
...
MobileMessageThreadInternal::MobileMessageThreadInternal(uint64_t aId,
  ...
  : mData(aId, aParticipants, aTimestamp, aLastMessageSubject, aBody,
          aUnreadCount, aLastMessageType, aIsGroup, aLastAttachmentStatus)
{
...
NS_IMETHODIMP
MobileMessageThreadInternal::GetLastAttachmentStatus(int32_t* aLastAttachmentStatus)
{
  *aLastAttachmentStatus = mData.lastAttachmentStatus();
  return NS_OK;
}
