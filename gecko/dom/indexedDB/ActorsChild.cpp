                                           ...
                                           const NullableVersion& aNewVersion)
{
  ...
  // Only DeleteDatabaseOp has null version. We force database to
  // AbortTransactions and Close if receiving DeleteDatabaseOp.
  if (aNewVersion.type() == NullableVersion::Tnull_t) {
    mDatabase->AbortTransactions(/* aShouldWarn */ false);
    mDatabase->Close();
  }
