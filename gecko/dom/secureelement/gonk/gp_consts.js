...
// Secure Element Access Control – Public Release v1.1
// Table 4-1: GET DATA Command Message
// CLA, INS, P1, P2, P3
this.GET_ALL_GP_DATA = [0x80, 0xCA, 0xFF, 0x40];

this.GET_REFRESH_GP_DATA = [0x80, 0xCA, 0xDF, 0x20];

this.GET_NEXT_GP_DATA = [0x80, 0xCA, 0xFF, 0x60];

this.GET_CONFIG_GP_DATA = [0x80, 0xCA, 0xDF, 0x21];

this.UPDATE_ALL_GP_DATA = [0x80, 0xE2, 0x90, 0x00, 0x1A, 0xF0, 0x10, 0xE2, 0x0E, 0xE1, 0x04, 0x4F, 0x00, 0xC1, 0x00, 0xE3, 0x06, 0xD0, 0x01, 0x01, 0xD1, 0x01, 0x01, 0xD7, 0xBD, 0x55, 0xD5, 0x86, 0xC0, 0x40, 0x01];
