...
BrowserElementParent.prototype = {
  ...
  download: function(_url, _options) {
    ...
    _options = _options || {};
    let fileName = _options.filename;
    ...
    try {
      ...
      debug("For protocol that doesn't implement nsIURL interface e = " + e);
      // Data url doesn't support url interface. Use a random file name here.
  ...
  scrollToTop: defineNoReturnMethod(function() {
    this._sendAsyncMsg('scroll-to-top');
  }),

  scrollToBottom: defineNoReturnMethod(function() {
    this._sendAsyncMsg('scroll-to-bottom');
  }),
