...
protected:
   ...
   * created.
   */
  void AbortExistingLoads(bool aClearLoadingSrc = true);
   ...
   */
  void DoLoad(bool aClearLoadingSrc = true);
...
private:
#ifdef MOZ_WIDGET_GONK
  bool IsVideoOffloadPlayer() const;
  bool IsVideoOffloadDisabled() const;
  bool DoesPricipalAllowVideoOffload() const;
  bool GetFDFromBlob(MediaDecoder* aDecoder);
  bool SetupVideoOffloadSurface();
#endif
...
#ifdef MOZ_WIDGET_GONK
  //Jimmy: use to provide the android surface to android::MediaPlayer
  RefPtr<nsDOMSurfaceControl> mSurfaceControl;
  MediaSurfaceControlBack* mSurfaceCallback;
  android::sp<android::IGraphicBufferProducer> mProducer;

  nsCOMPtr<nsIFile> mRemoteFile;
  int mRealFd;
#endif
};
