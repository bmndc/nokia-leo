...
public:
  ...
  AllocPImsRegServiceFinderChild() override;
  virtual bool
  DeallocPImsRegServiceFinderChild(PImsRegServiceFinderChild*) override;
  ...
  AllocPImsRegistrationChild(const uint32_t& aServiceId) override;
  virtual bool
  DeallocPImsRegistrationChild(PImsRegistrationChild* aActor) override;
...
#ifdef ENABLE_EMBMS
  virtual PLteBroadcastChild* AllocPLteBroadcastChild() override;

  virtual bool DeallocPLteBroadcastChild(PLteBroadcastChild* aActor) override;
#endif

#ifdef ENABLE_TEE_SUI
  virtual PTEEChild* AllocPTEEChild() override;

  virtual bool DeallocPTEEChild(PTEEChild* aActor) override;
#endif

#ifdef ENABLE_RSU
  virtual PRSUChild* AllocPRSUChild() override;

  virtual bool DeallocPRSUChild(PRSUChild* aActor) override;
#endif

#ifdef ENABLE_SOUNDTRIGGER
  virtual PSoundTriggerChild* AllocPSoundTriggerChild() override;
  virtual bool DeallocPSoundTriggerChild(PSoundTriggerChild* aActor) override;
#endif
