...
private:
...
#ifdef ENABLE_EMBMS
  virtual PLteBroadcastParent* AllocPLteBroadcastParent() override;

  virtual bool DeallocPLteBroadcastParent(PLteBroadcastParent* aActor) override;

  virtual bool RecvPLteBroadcastConstructor(PLteBroadcastParent* aActor) override;
#endif

#ifdef ENABLE_TEE_SUI
  virtual PTEEParent* AllocPTEEParent() override;

  virtual bool DeallocPTEEParent(PTEEParent* aActor) override;

  virtual bool RecvPTEEConstructor(PTEEParent* aActor) override;
#endif

#ifdef ENABLE_SOUNDTRIGGER
  virtual PSoundTriggerParent* AllocPSoundTriggerParent() override;
  virtual bool DeallocPSoundTriggerParent(PSoundTriggerParent* aActor) override;
#endif

#ifdef ENABLE_RSU
  virtual PRSUParent* AllocPRSUParent() override;

  virtual bool DeallocPRSUParent(PRSUParent* aActor) override;

  virtual bool RecvPRSUConstructor(PRSUParent* aActor) override;
#endif
  ...
  virtual bool RecvSetGeolocationOptions(const bool& aHighAccuracy,
                                         const bool& aE911,
                                         const uint16_t& aGpsMode) override;
