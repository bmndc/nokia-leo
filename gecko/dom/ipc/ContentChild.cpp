...
#ifdef ENABLE_EMBMS
#include "mozilla/dom/PLteBroadcastChild.h"
#endif

#ifdef ENABLE_TEE_SUI
#include "mozilla/dom/PTEEChild.h"
#endif
...
InitOnContentProcessCreated()
{
  ...
  hal::EnableScreenOrientationHolder();
}
...
#ifdef ENABLE_EMBMS
PLteBroadcastChild*
ContentChild::AllocPLteBroadcastChild()
{
  NS_NOTREACHED("We should never be manually allocating PLteBroadcastChild actors");
  return nullptr;
}

bool
ContentChild::DeallocPLteBroadcastChild(PLteBroadcastChild* aActor)
{
  return true;
}
#endif
...
#ifdef ENABLE_TEE_SUI
PTEEChild*
ContentChild::AllocPTEEChild()
{
  NS_NOTREACHED("We should never be manually allocating PTEEChild actors");
  return nullptr;
}

bool
ContentChild::DeallocPTEEChild(PTEEChild* aActor)
{
  return true;
}
#endif
...
{
  NS_NOTREACHED("We should never be manually allocating PRSUChild actors");
  return nullptr;
}
...
PSoundTriggerChild*
ContentChild::AllocPSoundTriggerChild()
{
  NS_NOTREACHED("We should never be manually allocating PSoundTriggerChild actors");
  return nullptr;
}

bool
ContentChild::DeallocPSoundTriggerChild(PSoundTriggerChild* aActor)
{
  return true;
}
#endif
