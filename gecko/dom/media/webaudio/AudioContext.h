...
public:
  ...
  void ForceAudioChannelPlaying(bool aSuspendAndAutoResume);

  void AudioChannelStateChanged(bool aPlaying);

  void AudioChannelMuted(bool aMuted);
...
private:
  ...
  bool mSuspendCalled;
  // Set by ForceAudioChannelPlaying(). Ture if need to resume AudioContext
  // after audio channel is unmuted.
  bool mAutoResume;
};
