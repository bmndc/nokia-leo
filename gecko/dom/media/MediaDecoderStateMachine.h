...
public:
  ...
  void DispatchMediaOffloading(bool aMediaOffloading)
  {
    RefPtr<MediaDecoderStateMachine> self = this;
    nsCOMPtr<nsIRunnable> r = NS_NewRunnableFunction([=] () {
      if (self->mMediaOffloading != aMediaOffloading) {
        self->mMediaOffloading = aMediaOffloading;
...
private:
  ...
  // True if media is offloading.
  // Playback will not start when media is offloading.
  bool mMediaOffloading;
