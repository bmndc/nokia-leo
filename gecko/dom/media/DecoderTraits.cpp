...
static const char* const gVideoOffloadPlayerTypes[] = {
  "video/mp4",
  "video/x-m4v",
  "video/3gpp",
  "video/3gpp2",
...
/* static */
bool DecoderTraits::IsVideoOffloadPlayerSupportedType(const nsACString& aType)
{
  if (!MediaDecoder::IsOmxEnabled()) {
    return false;
  }

  return CodecListContains(gVideoOffloadPlayerTypes, aType);
}
#endif
