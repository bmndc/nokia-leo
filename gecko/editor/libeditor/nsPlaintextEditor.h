...
// another class. Only the base class should use NS_DECL_ISUPPORTS
  ...
  NS_IMETHOD TypedTextMix(const nsAString& aString, ETypingAction aAction, int32_t mixLength,
                          int32_t mixIndex);
  NS_IMETHODIMP InsertTextExt(const nsAString &aStringToInsert, int32_t mixlength, int32_t mixIndex);
