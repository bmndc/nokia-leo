...
KeyboardInputMapper::KeyboardInputMapper(InputDevice* device,
    ...
    mNeedMicrophoneToggleKey = Preferences::GetBool("dom.microphonetoggle.supported") &&
    ...
    case EV_KEY: {
        ...
        if (isKeyboardOrGamepadKey(scanCode)) {
            ...
            if (keyCode == AKEYCODE_ENTER && mNeedMicrophoneToggleKey) {
              processKey(rawEvent->when, rawEvent->value != 0, AKEYCODE_MICROPHONE_TOGGLE, KEY_PROG1, flags);
            }
        }
        break;
    }
