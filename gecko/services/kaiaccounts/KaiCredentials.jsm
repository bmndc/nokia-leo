...
/**
 * This module implements client-side key stretching for use in KaiOS
...
this.EXPORTED_SYMBOLS = ["KaiCredentials"];
...
this.KaiCredentials = Object.freeze({
  ...
  setup: function(emailInput, passwordInput, options={}) {
    ...
    let salt = this.keyWordExtended("quickStretch", emailInput.toLowerCase());
